...
export const getDataBooksCart = async (req: Request, res: Response) => {
    ...
    try {
        if (userId) {
            ...
            const userCart = await Cart.findOne({ userId }); // findOne porque el usuario debe tener un único carrito
...
export const cleanAllCart = async (req: Request, res: Response) => {
